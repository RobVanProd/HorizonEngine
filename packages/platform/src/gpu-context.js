 ...
 */
async function acquireAdapter(powerPreference) {
    if (!navigator.gpu) {
    ...
    throw new Error('Failed to obtain GPUAdapter after all fallback attempts.\n\n' +
        'Possible fixes:\n' +
...
export async function createGPUContext(options) {
    ...
    if (adapterMaxBufferSize > 268435456) {
