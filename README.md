...
- The renderer now includes a dedicated stylized grass material path for merged blade fields with wind animation, broad field-scale color variation, thinner tapered blade profiles, and higher meadow-density coverage tuning for fuller first-level ground cover.
